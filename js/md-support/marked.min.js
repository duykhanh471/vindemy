...
!(function (e, t) {
                ...
                if (D)
                  if (((a = D.length), n[3] || n[4])) s += a;
                    ...
                    return (
                      ...
                      (D = e.slice(
                        0,
                        i + n.index + (n[0].length - D.length) + a
                      )),
                      Math.min(i, a) % 2
                        ? ((a = D.slice(1, -1)),
                          {
  ...
  (w._punctuation = "!\"#$%&'()+\\-.,/:;<=>?@\\[\\]`^{|}~"),
    ...
    (w.emStrong.lDelim = p(w.emStrong.lDelim)
  ...
  var v = (function () {
      ...
      return (
        ...
        (n.inlineTokens = function (r, t) {
          ...
          for (
            ;
            null != (n = this.tokenizer.rules.inline.escapedEmSt.exec(a));
          ...
          for (
            ...
            if (
              ...
              this.options.extensions &&
                ...
                (!1 !==
                  (A = this.options.extensions.renderers[a.type].call(
                    { parser: this },
                    a
                  )) ||
                  ![
                ...
                case "table":
                  for (l = D = "", r = a.header.length, u = 0; u < r; u++)
                    l += this.renderer.tablecell(
                      this.parseInline(a.header[u].tokens),
                      { header: !0, align: a.align[u] }
                    );
                  for (
              ...
              T.passThroughHooks.has(r)
                ? (a[r] = function (e) {
                    return I.defaults.async
                      ? Promise.resolve(s.hooks[r].call(a, e)).then(function (
                          e
                        ) {
                          return i.call(a, e);
                        })
