class t extends HTMLElement {
  ...
  constructor(t) {
    super(),
      ...
      (this.config = {
        markedUrl:
          "/vindemy/js/md-support/marked.min.js",
        prismUrl: [
          [
            "/vindemy/js/md-support/prism.min.js",
            "data-manual",
          ],
          "/vindemy/js/md-support/prism-autoloader.min.js",
        ],
        cssUrls: [
          "/vindemy/js/md-support/github-markdown.min.css",
          "/vindemy/js/md-support/prism.min.css",
        ],
        hostCss:
  ...
  fire(t, e = {}, s = { bubbles: !0, composed: !0 }) {
    e.msg && console.warn(e.msg),
      this.dispatchEvent(
        new CustomEvent(t, { detail: { node: this, ...e }, ...s })
      );
  }
  tick() {
  ...
  buildStyles() {
    ...
    return `<style>${this.config.hostCss}</style>${t(
      'template[data-merge="prepend"]'
    )}${
      t("template:not([data-merge])") ||
      e.reduce((t, e) => `${t}<link rel="stylesheet" href="${e}">`, "")
    }${t('template[data-merge="append"]')}`;
  }
  async buildMd(t = {}) {
    return (
      (await (async () => {
  ...
  async stampStyles(t) {
    ...
    if (s.getAttribute("data-hash") !== e) {
      ...
      const r = this.makeNodes(t),
        i = [...r].filter(
          (t) => "LINK" === t.tagName && "stylesheet" === t.getAttribute("rel")
        );
      return (
        (s.innerHTML = ""),
        s.append(...r),
  ...
  async stampBody(t, e) {
    ...
    if (i.getAttribute("data-hash") !== r) {
      i.setAttribute("data-hash", r),
        s.unshift("markdown-body"),
